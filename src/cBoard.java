...
//            设置棋子颜色
            if(x.getType()==1) g.setColor(Color.black);
     ...
     *获取格子大小
     */
    public int getLength(){ return (getHeight()-2*margin)/(cBoard_SIZE-1); }
    /*
     *获取边距
     */
     ...
     *获取边长
     */
    public int getcBoardSize(){ return cBoard_SIZE; }
    /*
    * 获取棋子半径
     */
    public int getPieceLength() {return getLength()-5;}

    /*
     * 清空落子集合
     */
    public void clearList(){ piecesList.clear(); repaint();}
